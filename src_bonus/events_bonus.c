...
/*   Updated: 2024/11/01 18:22:30 by ngoulios         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	move_view(t_fractal *fractal, double real_delta, double imag_delta);
...
void	handle_key_arrow(void *param)
{
	...
	move_view(fractal, real_delta, imag_delta);
	draw_fractal(fractal);
	mlx_image_to_window(fractal->mlx, fractal->img, 0, 0);
}
